...
public class CadeiraObrigatoria implements Cadeira{
    private int id;
    private String nome;
    ...
    public CadeiraObrigatoria(int id, String nome, int creditos, List<Integer> prerequisitos, List<Integer> corequisitos, int cargaHoraria,
                   int semestre) {
        super();
        this.id = id;
        this.nome = nome;
    ...
    public CadeiraObrigatoria(int id) {
        super();
        this.id = id;
