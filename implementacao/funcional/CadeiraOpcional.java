...
public class CadeiraOpcional implements Cadeira {
    private int id;
    private String nome;
    ...
    public CadeiraOpcional(int id, String nome, int creditos, List<Integer> prerequisitos, List<Integer> corequisitos, int cargaHoraria,
                   int semestre) {
        super();
        this.id = id;
        this.nome = nome;
